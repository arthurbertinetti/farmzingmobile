...
export const CROPS: CropDef[] = [
  ...
  { name: 'Salade', emoji: '\u{1F96C}', stageTime: 10, cost: 12, sellValue: 32, xp: 12, reqLevel: 2 },
  { name: 'Poivron', emoji: '\u{1FAD1}', stageTime: 16, cost: 16, sellValue: 45, xp: 16, reqLevel: 2 },
  { name: 'Ble', emoji: '\u{1F33E}', stageTime: 22, cost: 20, sellValue: 58, xp: 20, reqLevel: 3, resourceKey: 'ble' },
  { name: 'Concombre', emoji: '\u{1F952}', stageTime: 30, cost: 25, sellValue: 72, xp: 25, reqLevel: 3 },
  { name: 'Mais', emoji: '\u{1F33D}', stageTime: 40, cost: 30, sellValue: 88, xp: 30, reqLevel: 4, resourceKey: 'mais' },
  { name: 'Aubergine', emoji: '\u{1F346}', stageTime: 55, cost: 38, sellValue: 110, xp: 38, reqLevel: 5 },
  ...
  { name: 'Piment', emoji: '\u{1F336}\u{FE0F}', stageTime: 110, cost: 65, sellValue: 200, xp: 65, reqLevel: 8 },
  { name: 'Oignon', emoji: '\u{1F9C5}', stageTime: 135, cost: 78, sellValue: 240, xp: 78, reqLevel: 9, resourceKey: 'oignon' },
  { name: 'Brocoli', emoji: '\u{1F966}', stageTime: 165, cost: 92, sellValue: 290, xp: 92, reqLevel: 10 },
  { name: 'Melon', emoji: '\u{1F348}', stageTime: 200, cost: 110, sellValue: 350, xp: 110, reqLevel: 11 },
  { name: 'Pasteque', emoji: '\u{1F349}', stageTime: 240, cost: 130, sellValue: 420, xp: 130, reqLevel: 12 },
  { name: 'Champignon', emoji: '\u{1F344}', stageTime: 290, cost: 155, sellValue: 500, xp: 155, reqLevel: 14, resourceKey: 'champignon' },
  { name: 'Ail', emoji: '\u{1F9C4}', stageTime: 350, cost: 185, sellValue: 600, xp: 185, reqLevel: 16 },
