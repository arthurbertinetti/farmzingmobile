...
export const ANIMAL_FEED: AnimalFeedDef[] = [
  ...
  { feedResource: 'carotte',    feedQty: 5, outputResource: 'steak',        coinsPerTick: 0 },
  ...
  { feedResource: 'ble',        feedQty: 5, outputResource: 'plume_blanche', coinsPerTick: 0 },
  { feedResource: 'fraise',     feedQty: 5, outputResource: 'plume_blanche', coinsPerTick: 0 },
  { feedResource: 'banane',     feedQty: 4, outputResource: 'plume',         coinsPerTick: 0 },
  { feedResource: 'champignon', feedQty: 5, outputResource: 'plume',         coinsPerTick: 0 },
  { feedResource: 'fraise',     feedQty: 6, outputResource: 'oeuf_tortue',   coinsPerTick: 0 },
  { feedResource: 'coins',      feedQty: 2000, outputResource: 'nageoire',   coinsPerTick: 0 },
  { feedResource: 'mangue',     feedQty: 5, outputResource: 'canne_sucre',   coinsPerTick: 0 },
  { feedResource: 'fleur',      feedQty: 8, outputResource: 'corne',         coinsPerTick: 3000 },
];
